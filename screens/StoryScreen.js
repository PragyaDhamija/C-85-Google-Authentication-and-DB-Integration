...
import { Text, View, TouchableOpacity, Image, StyleSheet, SafeAreaView, Platform, StatusBar, FlatList } from 'react-native';
...
export default class StoryScreen extends Component {
    ...
    async initiateTTS(title, author, story, moral){
        const currentColour= this.state.speakerColor
        this.setState({
            speakerColor: currentColour==='gray'?'orange':'gray'
        })
        if(currentColour==='gray'){ 
            //`` - back tick , ${} - placeholder
                    ...
                    <View style={styles.storyContainer}>
                        <ScrollView style={styles.storyCard}>
                            ...
                            <View style={styles.dataContainer}>
                                ...
                                <View style={styles.iconContainer}>
                                    <TouchableOpacity onPress={() => {
                                        this.initiateTTS(
                                            this.props.route.params.story.title, this.props.route.params.story.author, this.props.route.params.story.story, this.props.route.params.story.moral
                                        )
                                    }}>
                                        <Ionicons style={{ margin: RFValue(15) }} size={RFValue(30)} name={this.state.speakerIcon} color={this.state.speakerColor} />
                            ...
                            <View style={styles.storyTextContainer}>
                                ...
                                <Text style={styles.storyMoralText}>{this.props.route.params.story.moral}</Text>
                            </View>
                            <View style={styles.actionContainer}>
                                <View style={styles.likeButton}>
                                    <Ionicons name={"heart"} size={RFValue(30)} color={"white"} />
                                    <Text style={styles.likeText}>42K</Text>
                                </View>
                            </View>
                        </ScrollView>
                    </View>
